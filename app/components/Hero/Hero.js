...
class Hero extends Component {
    render() {
        let imgClassName = this.props.page === 'agence-facebook-ads'
            ...
            : (['referencement-site-internet', 'agence-seo-local', 'pub', 'logos'].includes(this.props.page)
        ...
        return (
            <section className={`section-hero w-[98%] mx-auto bg-[var(--background)] pt-[170px] lg:pt-[220px] relative overflow-hidden rounded-b-2xl ${['referencement-site-internet', 'agence-seo-local', 'pub', 'logos'].includes(this.props.page) ? 'lg:pb-[289px]' : ''}`}>
