...
export default function SectionPrix(props) {
    return (
        <div className="relative overflow-hidden min-h-30 flex flex-col items-center justify-center rounded-lg p-10 py-30 text-center mt-12 bg-[var(--purple-bg)] lg:w-[85%] mx-auto">
            <div className="absolute left-0 top-0 bg-[url('/faq-bg.png')] bg-no-repeat bg-contain opacity-30 w-[1400px] h-[1400px]" />
            
            <p className="font-medium  z-[1]">À partir de</p>

            <div className="flex justify-center items-end gap-1 mt-4 text-[var(--purple)]  z-[1]">
                <p className="text-[115px] font-black font-clash leading-[70%] tracking-tighter">289€</p>
            ...
            <p className="font-medium mt-6  z-[1]">
                Transformez la manière dont vous attirez des clients.
            </p>
